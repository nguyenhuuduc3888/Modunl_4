    ...
    <form:form modelAttribute="person" method="post" action="/save">
        <div class="row mt-2">
            <div class="col-lg-12">
                ...
                <form:input path="fullName" cssClass="form-control" required = "true" pattern="[A-Z\\s]+"/>
            </div>
        </div>
        ...
        <div class="row mt-2">
            <div class="col-lg-4">
                ...
                <label class="text-danger">(*)</label>
                <form:select path="yearOfBirth" items="${dayOfBirth}" cssClass="form-select" required="true"/>
            </div>
            <div class="col-lg-4">
            ...
            <div class="col-lg-4">
                ...
                <label class="text-danger">(*)</label>
                <form:select path="nationality" items="${country}" cssClass="form-select" required="true"/>
            </div>
        </div>
        ...
        <div class="row mt-2">
            <div class="col-lg-12">
                ...
                <label class="text-danger">(*)</label>
                <form:input path="idCard" cssClass="form-control" required="true" pattern="[1-9]{1}[0-9]{8}"/>
            </div>
        </div>
        ...
        <div class="row mt-2">
            <div class="col-lg-12">
                ...
                <label class="text-danger">(*)</label>
                <form:radiobuttons path="travelInfo" items="${travel}" cssClass="form-check-inline fw-bold mx-2"
                                   required="true"/>
            </div>
        </div>
        <div class="row mt-2">
            <div class="col-lg-6">
                ...
                <form:input path="signalPlate" cssClass="form-control" alt="VD: VN123"/>
            </div>
            <div class="col-lg-6">
        ...
        <div class="row mt-2">
            <div class="col-lg-6">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <form:select path="startMonth" items="${month}" cssClass="form-select" required="true"/>
                    </div>
                    <div class="col-lg-4">
                        <form:select path="startYear" items="${year}" cssClass="form-select" required="true"/>
                    </div>
                </div>
            </div>
            <div class="col-lg-6">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <form:select path="endMonth" items="${month}" cssClass="form-select" required="true"/>
                    </div>
                    <div class="col-lg-4">
                        <form:select path="endYear" items="${year}" cssClass="form-select" required="true"/>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row mt-2">
            <div class="col-lg-12">
                ...
                <label class="text-danger">(*)</label>
                <form:input path="travel14DaysInfo" cssClass="form-control" required="true"/>
            </div>
        </div>
